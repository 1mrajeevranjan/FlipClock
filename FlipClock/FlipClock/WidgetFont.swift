...
struct WidgetFont: Identifiable, Hashable {
    ...
    static let bundled: [WidgetFont] = [
        ...
        WidgetFont(id: "KibbeGranite-Regular", label: "Kibbe Granite", fileName: "Kibbe Granite.ttf", postscriptName: "KibbeGranite-Regular"),
        ...
        WidgetFont(id: "MickeyMouseLinePERSONALUSE-Regular", label: "Mickey Mouse Line", fileName: "MickeyMouseLine_PERSONAL_USE_ONLY.otf", postscriptName: "MickeyMouseLinePERSONALUSE-Regular"),
        WidgetFont(id: "MickeyMousePERSONALUSE-Regular", label: "Mickey Mouse", fileName: "MickeyMouse_PERSONAL_USE_ONLY.otf", postscriptName: "MickeyMousePERSONALUSE-Regular"),
        WidgetFont(id: "OceanGrade", label: "Ocean Grade", fileName: "Ocean Grade.otf", postscriptName: "OceanGrade"),
        WidgetFont(id: "RoadyRoadrunner-New", label: "Road Runner", fileName: "rroadrunner.ttf", postscriptName: "New"),
        WidgetFont(id: "Snot", label: "Snot", fileName: "SNOT____.TTF", postscriptName: "Snot"),
        ...
        WidgetFont(id: "SqueakyPERSONALUSE-Regular", label: "Squeaky", fileName: "Squeaky_PERSONAL_USE_ONLY.otf", postscriptName: "SqueakyPERSONALUSE-Regular"),
        ...
        WidgetFont(id: "vtksuniversity", label: "VTKS University", fileName: "vtks university.ttf", postscriptName: "vtksuniversity"),
